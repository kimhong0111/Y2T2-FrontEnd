...
const STUDENTS_DATA = [
  { firstName: "An", lastName:"Kim", age: 20 },
  { firstName: "Bình",lastName:"Kim", age: 22 },
  { firstName: "Cẩm",lastName:"Kim", age: 21 },
  { firstName: "An",lastName:"Hong", age: 19 }, // Duplicate first name !
];
 ...
 */
function updateStudentAge(firstName,lasName, newAge) {
  let student = STUDENTS_DATA.find((s) => s.firstName === firstName && s.lastName===lasName);
